...
/* The `HaskellLibraryLoader` class exists to ensure that appropriate shared
 * objects (those in the 'jarify-app.zip' archive within the JAR in which this
 * class * resides) are dynamically loaded *before* attempting to access any
